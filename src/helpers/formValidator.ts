...
export const formValidator = (): ValidatorReturn => {
  ...
  const validator: Validator = {
    ...
    email(): typeof validator {
      const defaultMessage = 'Debe ser un email válido'
    ...
    equalTo(field: string,): typeof validator {
      ...
      validator.rules.push({
        ...
        message: `Este campo es diferente a ${field}`,
      })
      return validator;
    ...
    isValidPhone(): typeof validator {
      validator.rules.push({
        ...
        message: 'Debe ser un numero de teléfono válido',
      });
      return validator;
    },
    ...
    string(): typeof validator {
      const defaultMessage = 'El campo de ser válido';
      validator.rules.push({
